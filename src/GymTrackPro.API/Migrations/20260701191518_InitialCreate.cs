    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WalkInVisitors", x => x.VisitorID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "MembershipPauses",
                columns: table => new
                {
                    PauseID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubscriptionID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembershipPauses", x => x.PauseID);
                    table.ForeignKey(
                        name: "FK_MembershipPauses_Subscriptions_SubscriptionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipPauses_SubscriptionID",
