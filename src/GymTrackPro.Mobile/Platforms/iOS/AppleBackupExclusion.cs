...
internal static class AppleBackupExclusion
{
    ...
    {
        // AppData contains the standard SQLite cache and any journal/WAL/SHM
        // sidecars. Excluding the directory also covers future account-scoped files.
        // CacheDirectory is normally excluded by iOS, but mark both explicitly so
        // exported reports and future cache files remain outside iCloud backup.
